...
_=XulRunner_ is part of [JBoss Tools](http://jboss.org/tools) from
...
To build _=XulRunner_ requires specific versions of Java and
...
_=XulRunner_ is open source, and we welcome anybody that wants to
