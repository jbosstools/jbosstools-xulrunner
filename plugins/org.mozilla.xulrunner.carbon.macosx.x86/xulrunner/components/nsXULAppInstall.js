...
//@line 41 "/builds/slave/mozilla-1.9.2-macosx-xulrunner/build/xulrunner/setup/nsXULAppInstall.js"
...
const AppInstall = {
  ...
  installApplication : function ai_IA(aAppFile, aDirectory, aLeafName) {
    ...
    if (aDirectory == null) {
//@line 240 "/builds/slave/mozilla-1.9.2-macosx-xulrunner/build/xulrunner/setup/nsXULAppInstall.js"
      aDirectory = getDirectoryKey("LocApp");
      if (vendor)
        aDirectory.append(vendor);
//@line 251 "/builds/slave/mozilla-1.9.2-macosx-xulrunner/build/xulrunner/setup/nsXULAppInstall.js"
    }
    else {
    ...
    if (aLeafName == "") {
//@line 262 "/builds/slave/mozilla-1.9.2-macosx-xulrunner/build/xulrunner/setup/nsXULAppInstall.js"
      aLeafName = appName + ".app";
//@line 270 "/builds/slave/mozilla-1.9.2-macosx-xulrunner/build/xulrunner/setup/nsXULAppInstall.js"
    }
...
//@line 278 "/builds/slave/mozilla-1.9.2-macosx-xulrunner/build/xulrunner/setup/nsXULAppInstall.js"
...
//@line 348 "/builds/slave/mozilla-1.9.2-macosx-xulrunner/build/xulrunner/setup/nsXULAppInstall.js"
  }
};
