 ...
 * /builds/slave/mozilla-1.9.2-linux-xulrunner/build/uriloader/base/nsIWebProgressListener.idl
 */
...
public interface nsIWebProgressListener extends nsISupports {
  ...
  String NS_IWEBPROGRESSLISTENER_IID =
  ...
  long STATE_REDIRECTING = 2L;

  long STATE_TRANSFERRING = 4L;

  long STATE_NEGOTIATING = 8L;
   ...
   */
  long STATE_IS_REQUEST = 65536L;

  long STATE_IS_DOCUMENT = 131072L;

  long STATE_IS_NETWORK = 262144L;

  long STATE_IS_WINDOW = 524288L;
   ...
   */
  long STATE_RESTORING = 16777216L;
   ...
   */
  long STATE_IS_INSECURE = 4L;

  long STATE_IS_BROKEN = 1L;

  long STATE_IS_SECURE = 2L;
   ...
   */
  long STATE_SECURE_HIGH = 262144L;

  long STATE_SECURE_MED = 65536L;

  long STATE_SECURE_LOW = 131072L;
  ...
  /**
    ...
    */
  long STATE_IDENTITY_EV_TOPLEVEL = 1048576L;
   ...
   */
  void onStateChange(nsIWebProgress aWebProgress, nsIRequest aRequest, long aStateFlags, long aStatus);
   ...
   */
  void onStatusChange(nsIWebProgress aWebProgress, nsIRequest aRequest, long aStatus, String aMessage);
