 ...
 * /builds/slave/mozilla-1.9.2-linux-xulrunner/build/toolkit/components/places/public/nsIFaviconService.idl
 */
...
public interface nsIFaviconService extends nsISupports {
  ...
  String NS_IFAVICONSERVICE_IID =
    "{66f6b992-e2d3-43da-ba2a-d966e34a7654}";
   ...
   */
  void setFaviconData(nsIURI aFaviconURI, byte[] aData, long aDataLen, String aMimeType, double aExpiration);
   ...
   *         Thrown if the favicon is overbloated and won't be saved to the db.
   */
  void setFaviconDataFromDataURL(nsIURI aFaviconURI, String aDataURL, double aExpiration);
   ...
   */
  byte[] getFaviconData(nsIURI aFaviconURI, String[] aMimeType, long[] aDataLen);
   ...
   */
  String getFaviconDataAsDataURL(nsIURI aFaviconURI);
