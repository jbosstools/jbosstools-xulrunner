 ...
 * /builds/slave/mozilla-1.9.2-linux-xulrunner/build/uriloader/exthandler/nsIHandlerService.idl
 */
...
public interface nsIHandlerService extends nsISupports {
   ...
   */
  void fillHandlerInfo(nsIHandlerInfo aHandlerInfo, String aOverrideType);
   ...
   */
  String getTypeFromExtension(String aFileExtension);
