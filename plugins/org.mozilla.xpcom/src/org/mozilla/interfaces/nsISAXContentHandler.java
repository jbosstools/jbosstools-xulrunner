 ...
 * /builds/slave/mozilla-1.9.2-linux-xulrunner/build/parser/xml/public/nsISAXContentHandler.idl
 */
...
public interface nsISAXContentHandler extends nsISupports {
  ...
  String NS_ISAXCONTENTHANDLER_IID =
    "{2a99c757-dfee-4806-bff3-f721440412e0}";
   ...
   */
  void startElement(String uri, String localName, String qName, nsISAXAttributes attributes);
