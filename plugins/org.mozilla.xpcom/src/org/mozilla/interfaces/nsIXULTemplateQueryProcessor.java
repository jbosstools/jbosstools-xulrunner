 ...
 * /builds/slave/mozilla-1.9.2-linux-xulrunner/build/content/xul/templates/public/nsIXULTemplateQueryProcessor.idl
 */
...
public interface nsIXULTemplateQueryProcessor extends nsISupports {
  ...
  String NS_IXULTEMPLATEQUERYPROCESSOR_IID =
    "{970f1c36-5d2e-4cbc-a1cf-e3327b50df71}";
   ...
   */
  void addBinding(nsIDOMNode aRuleNode, nsIAtom aVar, nsIAtom aRef, String aExpr);
   ...
   */
  nsIXULTemplateResult translateRef(nsISupports aDatasource, String aRefString);
   ...
   */
  int compareResults(nsIXULTemplateResult aLeft, nsIXULTemplateResult aRight, nsIAtom aVar);
