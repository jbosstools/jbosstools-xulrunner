 ...
 * /builds/slave/mozilla-1.9.2-linux-xulrunner/build/embedding/browser/webBrowser/nsIPrintingPrompt.idl
 */
...
/**
   ...
   *  @param printSettings - PrintSettings for page setup (required)
   */
  void showPrinterProperties(String printerName, nsIPrintSettings printSettings);
